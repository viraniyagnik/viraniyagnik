...
- 📝Understanding of code versioning tools (GitHub, Git) 
- 📝Strong database skills 
- 📝Proficient in software design algorithms and data structure 
- 📝Expertise in doing unit tests and code debugging 
- 📝Practical knowledge of Raspberry Pi, Arduino, Machine Learning 
- 📝Curiosity and passion for constantly learning new things 
- 📝A mathematical person who likes to play with numbers 
- 📝Analysing and processing a great variety of data, statistics, and information
